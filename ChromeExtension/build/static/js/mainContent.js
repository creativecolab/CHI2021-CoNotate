...
_this2.checkBtn();}if(msg.type==="resizeWindow"){var previousClientWidth=_this2.clientWidth;_this2.clientWidth=document.documentElement.clientWidth;// While this may seem weird, we call the call the previous function to make sure we adapt to the range
if(parseFloat(_this2.container.style.left)!==0)_this2.previous(_this2.clientWidth-previousClientWidth);_this2.checkBtn();}});// Prevent default scrolling behavior when hovered over the top menu
this.scrollEvent=function(e){if(stopScroll){e.preventDefault();e.stopPropagation();if(e.wheelDeltaY<0)_this2.next(100);else _this2.previous(100);}};window.addEventListener('wheel',this.scrollEvent,{passive:false});}},{key:"disconnectedCallback",value:function disconnectedCallback(){this.nextBtn.removeEventListener('click',this.next);this.previousBtn.removeEventListener('click',this.previous);window.removeEventListener('wheel',this.scrollEvent,{passive:false});}},{key:"emptyMessage",get:function get(){return this.getAttribute('emptyMessage');},set:function set(value){this.setAttribute('emptyMessage',value);}},{key:"clientWidth",get:function get(){return this.getAttribute('clientWidth');},set:function set(value){this.setAttribute('clientWidth',value);}},{key:"length",get:function get(){return this.getAttribute('length');},set:function set(value){this.setAttribute('length',value);}}],[{key:"observedAttributes",get:function get(){return['clientWidth','emptyMessage','length'];}}]);return SuggestionContainer;}(/*#__PURE__*/wrapNativeSuper_wrapNativeSuper(HTMLElement)));// Immediate invokation since we want top-level async
